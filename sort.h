#ifndef _SEQUENCEL_GENERATED_sort_H
#define _SEQUENCEL_GENERATED_sort_H
...
void sl_main(::Sequence< ::Sequence< char > > &_SequenceL__Arg_arg1, int _n, ::Sequence< ::_sl_CollisionRecord_0 > &_SequenceL_);
