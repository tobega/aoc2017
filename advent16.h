#ifndef _SEQUENCEL_GENERATED_advent16_H
#define _SEQUENCEL_GENERATED_advent16_H
...
void sl_main(::Sequence< ::Sequence< char > > &_SequenceL__Arg_arg1, int _n, ::Sequence< ::Sequence< char > > &_SequenceL_);
